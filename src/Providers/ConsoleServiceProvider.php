...
class ConsoleServiceProvider extends ServiceProvider
{
    protected array $commands = [
        ...
        Plugin\Makers\MailMakeCommand::class,
        MiddlewareMakeCommand::class,
        Plugin\Makers\NotificationMakeCommand::class,
        ProviderMakeCommand::class,
        RouteProviderMakeCommand::class,
        ListCommand::class,
        ModuleDeleteCommand::class,
        ModuleMakeCommand::class,
        Plugin\Makers\FactoryMakeCommand::class,
        Plugin\Makers\PolicyMakeCommand::class,
        ...
        \Juzaweb\Translation\Commands\Plugins\ImportTranslationCommand::class,
        \Juzaweb\Translation\Commands\Plugins\TranslateViaGoogleCommand::class,
        \Juzaweb\Translation\Commands\Plugins\ExportTranslationCommand::class,
        Plugin\Makers\RepositoryMakeCommand::class,
        \Juzaweb\Translation\Commands\Themes\ExportTranslationCommand::class,
        \Juzaweb\Translation\Commands\Themes\ImportTranslationCommand::class,
        \Juzaweb\Translation\Commands\Themes\TranslateViaGoogleCommand::class,
